                ...
                <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100 table-bordered" id="tickets-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <span class="badge badge-info fs-3">CLIENT</span></td>
                        @elseif($party->party_type == 'vendor')
                        <td> <span class="badge badge-warning ">VENDOR</span></td>
                        @elseif($party->party_type == 'employee')
                        <td> <span class="badge badge-primary fs-1">EMPLOYEE</span></td>
                        @else
