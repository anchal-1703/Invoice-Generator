            ...
            <div class="card-box">
                ...
                <div class="clearfix">
                    <div class="text-center">
                        <h1>Veritos Infosolutions Pvt Ltd</h1>
                    </div>
                    <div class="text-center">
                        <span>Mohali-160071 (Punjab.) India</span><br>
                        <span><b>Email:</b> info@veritos.com | <b>Web:</b> www.veritos.in | <b>Mob:</b>
                            +91-8968321512</span>
                    </div>
                    <div class="row pb-1">
                ...
                <div class="row border">
                    <div class="col-sm-6 col-lg-9 p-0">
                        <div class="clearfix pt-2 pb-2 mt-1 mb-1 ml-1 text-center" style="background-color: rgba(218, 218, 218, 0.37); border-radius: 5px;">
                            ...
                            <p><b>ABC BANK - ACCOUNT NO: 180011220011012 - IFSC: ABC30001011</b></p>
                        </div>
                        <div class="clearfix pt-2 pb-2 mt-1 mb-1 ml-1 text-center" style="background-color: rgba(218, 218, 218, 0.37); border-radius: 5px;">
                            <h5><b>Payment Method</b></h5>
                            <p><b>{{$bill->payment_method }}</b></p>
                        </div>
                    </div> <!-- end col -->
