...
!(function (e, t) {
    ...
    p(document)
        ...
        p(window).on(P.LOAD_DATA_API, function () {
            ...
            for (
                var r = 0,
                    s = (e = [].slice.call(document.querySelectorAll(A)))
                        .length;
                r < s;
                r++
            ) {
            ...
            return (
                ...
                (e._getItemIndex = function (e) {
                    return (
                        (this._items =
                            e && e.parentNode
                                ? [].slice.call(
                                      e.parentNode.querySelectorAll(ie)
                                  )
                                : []),
                ...
                (e._setActiveIndicatorElement = function (e) {
                    if (this._indicatorsElement) {
                        var t = [].slice.call(
                            this._indicatorsElement.querySelectorAll(te)
                        );
                        p(t).removeClass(z);
                        var n =
        ...
        De = (function () {
            ...
            return (
                ...
                (e._addAriaAndCollapsedClass = function (e, t) {
                    ...
                    t.length &&
                        p(t).toggleClass(be, !n).attr("aria-expanded", n);
                }),
    ...
    function We(e, t) {
        ...
        if ((e !== s && t !== s) || i.contains(o))
            return (function (e) {
                ...
                return (
                    "BODY" !== t &&
                    ("HTML" === t || Fe(e.firstElementChild) === e)
                );
            })(s)
                ? s
                : Fe(s);
    ...
    var Ct = {
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function (e, t) {
                        ...
                        var o = e.placement.split("-")[0],
                            ...
                            p = nt(i)[c];
                        a[d] - p < s[u] &&
                            (e.offsets.popper[u] -= s[u] - (a[d] - p)),
                            a[u] + p > s[d] &&
                                (e.offsets.popper[u] += a[u] + p - s[d]),
                ...
                hide: {
                    ...
                    fn: function (e) {
                        if (
                            !gt(e.instance.modifiers, "hide", "preventOverflow")
                        )
                            return e;
    ...
    function Dt(e, t) {
        ...
        !(function (e, t) {
            ...
            Object.keys(ze({}, Dt.Defaults.modifiers, i.modifiers)).forEach(
                function (e) {
    ...
    var tn = "modal",
        ...
        wn = (function () {
            ...
            return (
                ...
                (e._getConfig = function (e) {
                    return (
                        (e = l({}, sn, {}, e)), m.typeCheckConfig(tn, e, an), e
                    );
                }),
                ...
                (e._showElement = function (e) {
                    ...
                    if (n) {
                        var s = m.getTransitionDurationFromElement(
                            this._dialog
                        );
                        p(this._dialog)
                ...
                (e._setEscapeEvent = function () {
                    ...
                    this._isShown && this._config.keyboard
                        ...
                        : this._isShown ||
                          p(this._element).off(ln.KEYDOWN_DISMISS);
                }),
                        ...
                        !(function (e, t) {
                            ...
                            if (-1 !== t.indexOf(n))
                                return (
                                    -1 === Tn.indexOf(n) ||
                                    Boolean(
                                        e.nodeValue.match(Sn) ||
                                            e.nodeValue.match(Dn)
                                    )
                                );
                            for (
            ...
            return (
                ...
                (e._enter = function (e, t) {
                    ...
                    (t = t || p(e.currentTarget).data(n)) ||
                        ...
                        e &&
                            (t._activeTrigger["focusin" === e.type ? Vn : Qn] =
                                !0),
                        p(t.getTipElement()).hasClass(Bn) ||
                        t._hoverState === Fn
                            ? (t._hoverState = Fn)
                ...
                (e._leave = function (e, t) {
                    ...
                    (t = t || p(e.currentTarget).data(n)) ||
                        ...
                        p(e.currentTarget).data(n, t)),
                        e &&
                            (t._activeTrigger["focusout" === e.type ? Vn : Qn] =
                                !1),
